...
const professionals = [
  { id: 1, name: "Ana García", title: "Arquitecta Senior", skills: ["Diseño Residencial", "Arquitectura Sostenible", "Planificación Urbana"], rating: 4.8, image: "/placeholder.svg?height=300&width=400", projects: 32, hourlyRate: 75, availability: "Tiempo completo", location: "Barcelona, España" },
  { id: 2, name: "Carlos Rodríguez", title: "Diseñador de Interiores", skills: ["Diseño Comercial", "Remodelación", "Visualización 3D"], rating: 4.6, image: "/placeholder.svg?height=300&width=400", projects: 28, hourlyRate: 65, availability: "Freelance", location: "Madrid, España" },
  { id: 3, name: "Laura Martínez", title: "Arquitecta Paisajista", skills: ["Diseño de Jardines", "Arquitectura Sostenible", "Planificación Urbana"], rating: 4.9, image: "/placeholder.svg?height=300&width=400", projects: 45, hourlyRate: 80, availability: "Tiempo parcial", location: "Valencia, España" },
  { id: 4, name: "Miguel Sánchez", title: "Arquitecto de Conservación", skills: ["Restauración", "Patrimonio Histórico", "Diseño Sostenible"], rating: 4.7, image: "/placeholder.svg?height=300&width=400", projects: 37, hourlyRate: 70, availability: "Tiempo completo", location: "Sevilla, España" },
  { id: 5, name: "Elena Torres", title: "Arquitecta de Proyectos", skills: ["Gestión de Proyectos", "Diseño Comercial", "Arquitectura Sostenible"], rating: 4.5, image: "/placeholder.svg?height=300&width=400", projects: 25, hourlyRate: 72, availability: "Freelance", location: "Bilbao, España" },
  { id: 6, name: "Javier López", title: "Arquitecto Técnico", skills: ["Supervisión de Obras", "Eficiencia Energética", "Normativa de Construcción"], rating: 4.8, image: "/placeholder.svg?height=300&width=400", projects: 41, hourlyRate: 68, availability: "Tiempo completo", location: "Málaga, España" },
]
